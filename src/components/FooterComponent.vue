<template>
	<footer class="footer">
		...
		<section class="footer__social-media">
			...
			<a href="https://fiverr.com/sam_bustos" target="_blank">
				<IconComponent>
					<path
						d="M15 3h-2a6 6 0 0 0 -6 6h-3v4h3v8h4v-7h4v7h4v-11h-8v-1.033a1.967 1.967 0 0 1 2 -1.967h2v-4z" />
				</IconComponent>
			</a>
			<a href="mailto:sam.alejandro.bustos@gmail.com" target="_blank">
				<IconComponent>
					<path
			...
			<a href="https://t.me/@Zero10903" target="_blank">
				<IconComponent>
					<path
			...
			<a href="https://discordapp.com/users/262404619248861184" target="_blank">
				<IconComponent>
					<path
